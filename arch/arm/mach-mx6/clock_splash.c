...
//#ifndef CONFIG_MX6_CLK_FOR_BOOTUI_TRANS
	...
	*/
...
#ifdef CONFIG_MX6_CLK_FOR_BOOTUI_TRANS /* HDMI*/
	{
		u32 chsccdr;
		chsccdr = __raw_readl(MXC_CCM_CHSCCDR);
		chsccdr &= ~(MXC_CCM_CHSCCDR_IPU1_DI0_PRE_CLK_SEL_MASK
				| MXC_CCM_CHSCCDR_IPU1_DI0_PODF_MASK
				| MXC_CCM_CHSCCDR_IPU1_DI0_CLK_SEL_MASK);
		__raw_writel(chsccdr |
			5 << MXC_CCM_CHSCCDR_IPU1_DI0_PRE_CLK_SEL_OFFSET |
			2 << MXC_CCM_CHSCCDR_IPU1_DI0_PODF_OFFSET ,  MXC_CCM_CHSCCDR);
	}
#endif
...
#ifdef CONFIG_MX6_CLK_FOR_BOOTUI_TRANS /* HDMI*/
		     3 << MXC_CCM_CCGRx_CG2_OFFSET |	/* hdmi_tx_isfrclk_enable */
		     3 << MXC_CCM_CCGRx_CG0_OFFSET |	/* hdmi_tx_iahbclk_enable */
#endif
	...
	__raw_writel(1 << MXC_CCM_CCGRx_CG14_OFFSET |
		      ...
		      */
		     3 << MXC_CCM_CCGRx_CG7_OFFSET |	/* ldb_di1_clk_enable */
		     3 << MXC_CCM_CCGRx_CG6_OFFSET |	/* ldb_di0_clk_enable */
#if 0							
	/* MX6DLS */ 3 << MXC_CCM_CCGRx_CG5_OFFSET |	/* epdc_pix_clk_enable */
	/* MX6DLS */ 3 << MXC_CCM_CCGRx_CG4_OFFSET |	/* lcdif_pix_clk_enable */
	/* MX6DLS */ 3 << MXC_CCM_CCGRx_CG3_OFFSET |	/* epdc_axi_clk_enable, also for lcd?? */
#endif
#if 0
	/* MX6QD */  3 << MXC_CCM_CCGRx_CG5_OFFSET |	/* ipu2_ipu_di1_clk_enable */
	/* MX6QD */  3 << MXC_CCM_CCGRx_CG4_OFFSET |	/* ipu2_ipu_di0_clk_enable */
	/* MX6QD */  3 << MXC_CCM_CCGRx_CG3_OFFSET |	/* ipu2_ipu_clk_enable */
#endif
		     3 << MXC_CCM_CCGRx_CG2_OFFSET |	/* ipu1_ipu_di1_clk_enable */
		     3 << MXC_CCM_CCGRx_CG1_OFFSET |	/* ipu1_ipu_di0_clk_enable */
		     3 << MXC_CCM_CCGRx_CG0_OFFSET |	/* ipu1_ipu_clk_enable */
#endif
	...
	__raw_writel(3 << MXC_CCM_CCGRx_CG7_OFFSET |
			...
			(3 << MXC_CCM_CCGRx_CG11_OFFSET) |	/* pwm4_clk_enable */
			(3 << MXC_CCM_CCGRx_CG10_OFFSET) |	/* pwm3_clk_enable */
			(3 << MXC_CCM_CCGRx_CG9_OFFSET) |	/* pwm2_clk_enable */
			(3 << MXC_CCM_CCGRx_CG8_OFFSET) |	/* pwm1_clk_enable */
	#endif
#endif
...
#ifndef CONFIG_MX6_CLK_FOR_BOOTUI_TRANS /* HDMI*/
	/* Turn off HDMI PHY. */
